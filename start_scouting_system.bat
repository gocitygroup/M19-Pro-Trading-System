@echo off
REM ============================================================================
REM G-SignalX-M19-Trading-System - Scouting System Launcher
REM ============================================================================
REM This script starts the Scouting Trading System with 4 components:
REM   1. Web Interface (app.py)
REM   2. Profit Scouting Bot (ProfitScoutingBot.py)
...
echo.
echo ============================================================================
echo G-SignalX-M19-Trading-System - Scouting System Launcher
echo ============================================================================
echo.
...
call :START_APP "Profit Scouting Bot" "python src/scripts/ProfitScoutingBot.py" "Profit Scouting Bot"
